  ...
  return (
    <View style={styles.header}>
      {back ? <Pressable style={styles.iconButton} onPress={onBack}><Feather name="arrow-left" size={21} color={colors.ink} /></Pressable> : (
        <Image source={require('./assets/cravio-logo.png')} style={styles.brandLogo} resizeMode="cover" accessibilityLabel="Cravio" />
      )}
      <View style={{ flex: 1 }}>
